...
public class StoryAdapter extends ArrayAdapter<Story> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView storyDate = (TextView) listItemView.findViewById(R.id.author);
        storyDate.setText(currentStory.getStoryDate());


        // Assign story URL to TextView
        TextView storyURL = (TextView) listItemView.findViewById(R.id.date);
        storyURL.setText(currentStory.getStoryURL());
